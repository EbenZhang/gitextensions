...
namespace GitCommands
{
    ...
    public static class AppSettings
    {
        ...
        {
            get => GetBool("closecommitdialogaftercommit", false);
        ...
        {
            get => GetBool("AlwaysShowAdvOpt", true);
        ...
        {
            get => GetBool("DontConfirmPushNewBranch", true);
        ...
        {
            get => GetBool("closeprocessdialog", true);
        ...
        {
            get => GetBool("UseConsoleEmulatorForCommands", false);
