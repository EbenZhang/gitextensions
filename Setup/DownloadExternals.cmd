...
IF NOT EXIST "%~p0\cache\Git-2.16.2-32-bit.exe" (
    "%~p0\tools\curl.exe" -L -k -o %~p0\cache\Git-2.16.2-32-bit.exe https://github.com/git-for-windows/git/releases/download/v2.16.2.windows.1/Git-2.16.2-32-bit.exe
