...
if ($shouldSignArtifacts -eq $true) {
    ...
    # sign
    $description = "https://ci.appveyor.com/project/EbenZhang/gitextensions/builds/$env:APPVEYOR_BUILD_ID`n$env:APPVEYOR_REPO_COMMIT_MESSAGE`n$env:APPVEYOR_REPO_BRANCH from $env:APPVEYOR_PULL_REQUEST_HEAD_REPO_BRANCH";
    try {
