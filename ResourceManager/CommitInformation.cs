...
namespace ResourceManager
{
    public class CommitInformation
    {
        ...
        public static CommitInformation GetCommitInfo(GitModule module, LinkFactory linkFactory, string sha1)
        {
            ...
            string header = data.GetHeader(module, linkFactory, false);
        ...
        public static CommitInformation GetCommitInfo(CommitData data, bool showRevisionsAsLinks,
            LinkFactory linkFactory, IGitRevisionProvider module = null)
        {
            if (data == null)
                throw new ArgumentNullException("data");

            string header = data.GetHeader(module, linkFactory, showRevisionsAsLinks);
            string body = "\n" + WebUtility.HtmlEncode(data.Body.Trim());
        ...
        private static string ProcessHashCandidate(IGitRevisionProvider module, LinkFactory linkFactory, string hash)
        {
            if (module == null)
                return hash;
            string fullHash;
